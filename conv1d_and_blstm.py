...
print("Finish 0 pad")
print("This is printing df.Shape. It should be 18662 * 1000 * 102")
print(data.shape)
...
model.add(Conv1D(filters=64, kernel_size=2, stride=1, padding='same', activation='relu')) # conv1d here, try power of 2 for filters (32, 64, 128), try 2, 3, 4 for kernel_size
...
model.add(Dense(1, activation='relu')) # fully connected with relu
